...
This folder’s screenshots (`riskforge_demo_01_overview.png` …) were captured against the local deterministic API. They are **demo** illustrations, not observed-market evidence. Prefer live UI numbers over screenshot figures.
