...
- ``QUANTLINEAGE_MAX_POSITIONS=500``
- ``QUANTLINEAGE_MAX_SCENARIOS=50``
- ``QUANTLINEAGE_MAX_REQUEST_BYTES=1048576`` (1 MiB)
...
ENV_MAX_POSITIONS = "QUANTLINEAGE_MAX_POSITIONS"
ENV_MAX_SCENARIOS = "QUANTLINEAGE_MAX_SCENARIOS"
ENV_MAX_REQUEST_BYTES = "QUANTLINEAGE_MAX_REQUEST_BYTES"
