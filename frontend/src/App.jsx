...
import { Attribution, Hierarchy, RiskFactors, RiskRuns, VaRAnalytics } from './components/Analytics'
...
export default function App() {
  ...
  return <main>
    ...
    <section className="grid"><RiskFactors items={factors}/><VaRAnalytics report={varReport}/><Contributors items={contributors}/><Limits items={limits} portfolio={portfolio}/><Hierarchy node={hierarchy}/><Attribution report={attribution}/><RiskRuns portfolio={portfolio}/><ReverseStress portfolio={portfolio}/><Stress items={stress}/><ThreatScenarios report={threats}/><ScenarioBuilder portfolio={portfolio}/><HedgeCompare portfolio={portfolio}/><RiskQuery portfolio={portfolio}/></section>
